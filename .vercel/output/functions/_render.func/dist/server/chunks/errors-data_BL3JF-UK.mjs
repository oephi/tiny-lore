//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@vercel+functions@3.9.3_idb-keyval@6.3.0/node_modules/astro/dist/core/errors/utils.js
function normalizeLF(code) {
	return code.replace(/\r\n|\r(?!\n)|\n/g, "\n");
}
//#endregion
//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@vercel+functions@3.9.3_idb-keyval@6.3.0/node_modules/astro/dist/core/errors/printer.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@vercel+functions@3.9.3_idb-keyval@6.3.0/node_modules/astro/dist/core/errors/errors.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@vercel+functions@3.9.3_idb-keyval@6.3.0/node_modules/astro/dist/core/errors/errors-data.js
...
//#endregion
export { MissingImageDimension as A, PrerenderClientAddressNotAvailable as B, InvalidImageService as C, MiddlewareNoDataOrNextCalled as D, LocalsReassigned as E, NoMatchingImport as F, RewriteWithBodyUsed as G, RemoteImageNotAllowed as H, NoMatchingRenderer as I, UnknownContentCollectionError as J, StaticClientAddressNotAvailable as K, NoMatchingStaticPathFound as L, MissingSharp as M, NoClientOnlyHint as N, MiddlewareNotAResponse as O, NoImageMetadata as P, AstroError as Q, OnlyResponseCanBeReturned as R, InvalidGetStaticPathsReturn as S, LocalsNotAnObject as T, ReservedSlotName as U, PrerenderDynamicEndpointPathCollide as V, ResponseSentError as W, UnsupportedImageFormat as X, UnsupportedImageConversion as Y, i18nNoLocaleFoundInPath as Z, GetStaticPathsRequired as _, ClientAddressNotAvailable as a, InvalidComponentArgs as b, ExpectedImageOptions as c, FontFamilyNotFound as d, FontFileUrlNotFound as f, GetStaticPathsInvalidRouteParam as g, GetStaticPathsExpectedParams as h, CacheNotEnabled as i, MissingMediaQueryDirective as j, MissingGetFontFileRequestUrl as k, ExpectedNotESMImage as l, GetEntryDeprecationError as m, ActionsReturnedInvalidDataError as n, EndpointDidNotReturnAResponse as o, ForbiddenRewrite as p, UnavailableAstroGlobal as q, AstroResponseHeadersReassigned as r, ExpectedImage as s, ActionNotFoundError as t, FailedToFetchRemoteImageDimensions as u, ImageMissingAlt as v, LocalImageUsedWrongly as w, InvalidGetStaticPathsEntry as x, IncompatibleDescriptorOptions as y, PageNumberParamNotFound as z };
