...
import { M as MissingSharp, P as NoImageMetadata, Q as AstroError, X as UnsupportedImageFormat } from "./errors-data_BL3JF-UK.mjs";
import { r as detector } from "./remoteProbe_BTYCCPub.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_LhXugo68.mjs";
//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@vercel+functions@3.9.3_idb-keyval@6.3.0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./lib_ChdTYj-_.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
	} catch {
