...
function BreakpointProvider(props) {
  ...
  if ($[0] !== value || $[1] !== children) {
    t0 = /*#__PURE__*/jsx(BreakpointContext.Provider, {
      value: value,
      children: children
    });
    $[0] = value;
...
function useResponsiveValue() {
  ...
  let t0;
  if ($[0] !== bp) {
    t0 = function responsiveValue(value) {
...
function useMatchedBreakpoints() {
  ...
  const [breakpoint, setBreakpoint] = useState(t1);
  let t2;
  let t3;
...
function FocusRing(props) {
  ...
  if ($[0] !== children || $[1] !== isFocusVisible || $[2] !== props || $[3] !== isFocused || $[4] !== focusProps) {
    ...
    t0 = /*#__PURE__*/cloneElement(child, mergeProps(child.props, {
      ...focusProps,
      ...toDataAttributes({
