...
const PopoverWrapper = /*#__PURE__*/forwardRef(function PopoverWrapper(props, forwardedRef) {
  ...
  let t3;
  if ($[14] !== isNonModal || $[15] !== underlayProps || $[16] !== isOpen) {
  ...
  let t4;
  if ($[18] !== styleProps.style || $[19] !== popoverProps.style) {
    t4 = {
      ...styleProps.style,
      ...popoverProps.style
    };
    $[18] = styleProps.style;
    $[19] = popoverProps.style;
    $[20] = t4;
  } else {
    t4 = $[20];
  }
  let t5;
  if ($[21] !== isNonModal || $[22] !== state) {
  ...
  let t6;
  if ($[24] !== hideArrow || $[25] !== placement || $[26] !== arrowProps) {
  ...
  let t8;
  if ($[30] !== styleProps || $[31] !== popoverProps || $[32] !== t4 || $[33] !== popoverRef || $[34] !== t5 || $[35] !== t6 || $[36] !== children || $[37] !== t7) {
